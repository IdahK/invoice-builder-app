      ...
      <div className="space-y-1">
        ...
        <textarea
          ...
          className={`
            ...
            dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-gray-400 dark:focus:border-violet-500 dark:focus:ring-1 dark:focus:ring-violet-500
